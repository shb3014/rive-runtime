#!/bin/bash
# Build universal_tracker_demo on device

set -e

cd "$(dirname "$0")"

echo "=== Building Universal Tracker Demo ==="
...
echo "Compiling universal_tracker_demo.cpp..."
clang++ $CXXFLAGS -c universal_tracker_demo.cpp -o bin/release/universal_tracker_demo.o
...
echo "Linking..."
clang++ bin/release/universal_tracker_demo.o bin/release/drm_egl_context.o \
    $LDFLAGS -o bin/release/universal_tracker_demo

echo ""
echo "=== Build Complete ==="
echo "Binary: bin/release/universal_tracker_demo"
echo ""
echo "Usage:"
...
echo "       ./bin/release/universal_tracker_demo [--inspect] [--timing] \\"
echo "       [--resolution 500] <your-file.riv>"
echo ""
