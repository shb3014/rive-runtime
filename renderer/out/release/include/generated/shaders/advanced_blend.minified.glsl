...
#ifdef ENABLE_HSL_BLEND_MODES
case zd:if(ENABLE_HSL_BLEND_MODES){h0.xyz=clamp(h0.xyz,E0(.0),E0(1.));R0=Fa(h0.xyz,n0.xyz,n0.xyz);}break;case Ad:if(ENABLE_HSL_BLEND_MODES){h0.xyz=clamp(h0.xyz,E0(.0),E0(1.));R0=Fa(n0.xyz,h0.xyz,n0.xyz);}break;case Bd:if(ENABLE_HSL_BLEND_MODES){h0.xyz=clamp(h0.xyz,E0(.0),E0(1.));R0=O8(h0.xyz,n0.xyz);}break;case Cd:if(ENABLE_HSL_BLEND_MODES){h0.xyz=clamp(h0.xyz,E0(.0),E0(1.));R0=O8(n0.xyz,h0.xyz);}break;
#endif
